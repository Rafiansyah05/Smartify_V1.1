    ...
    <div className="max-w-md mx-auto bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
      ...
      <form onSubmit={handleJoin} className="space-y-4">
        ...
        <button 
          type="submit" 
          disabled={submitting} 
          className="w-full rounded-full bg-cyan-400 px-4 py-3 text-sm font-semibold text-white transition-colors hover:bg-cyan-500 disabled:opacity-50"
        >
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <div className="grid grid-cols-3 gap-4 mb-8">
            ...
            <div className="text-center">
              ...
              <p className={`text-2xl font-bold capitalize ${getDifficultyColor(quiz?.tingkat_kesulitan)}`}>
                {quiz?.tingkat_kesulitan || 'Medium'}
              </p>
            </div>
          </div>
              ...
              {participants.map((participant) => (
                ...
                >
                  <div>
                    ...
                    <span className={`text-xs ${participant.status === 'success' ? 'text-emerald-500' : 'text-amber-500'}`}>
                      {participant.status === 'success' ? 'Ready' : 'Connecting...'}
                    </span>
                  </div>
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="text-center">
                  ...
                  <p className={`text-xl font-bold capitalize ${getDifficultyColor(quiz?.tingkat_kesulitan)}`}>
                    {quiz?.tingkat_kesulitan || 'Medium'}
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6">
              <div className="text-center">
                {qrUrl ? (
                  <div className="relative mx-auto w-full max-w-[220px]">
                    <img 
                      ...
                      src={`${QR_SERVICE}?size=280x280&data=${encodeURIComponent(qrUrl)}`} 
                      alt="QR Code Smartify" 
                  ...
                  <div className="h-56 flex items-center justify-center text-sm text-gray-400 bg-gray-50 rounded-2xl">
                ...
                <div className="mt-6 border-t border-gray-100 pt-6">
                  ...
                  <p className="text-sm text-gray-500 mt-1">Open your camera<br />to join the lobby instantly.</p>
                  
                  <button 
                    onClick={openQrFull}
                    className="mt-4 w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
                  >
                    Buka QR
                  </button>
                </div>
