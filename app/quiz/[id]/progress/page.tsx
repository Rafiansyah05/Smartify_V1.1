...
export default function QuizProgressPage() {
  ...
  const filteredParticipants = useMemo(() => {
    return participants.filter(p => 
      p.nama_siswa.toLowerCase().includes(searchQuery.toLowerCase())
    );
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => fetchProgress(false), 5000);
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            ...
            <div className="flex items-center gap-3">
              <button 
                ...
                className="p-3 bg-cyan-400 hover:bg-cyan-500 text-white rounded-full transition-colors"
              >
