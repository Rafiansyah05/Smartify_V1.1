...
export function Navbar() {
  ...
  return (
    <nav
      className="fixed top-0 right-0 z-30 h-16 bg-white border-b border-gray-100 transition-all duration-300"
      style={{ left: '256px' }}
    >
      <div className="flex items-center justify-end h-full px-6 gap-4">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center justify-center w-10 h-10 rounded-full overflow-hidden border-2 border-gray-100 hover:border-primary transition-colors"
          >
